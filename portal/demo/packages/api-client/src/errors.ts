...
export const ERROR_COPY: Record<string, string> = {
  ...
  card_incomplete: 'На карточке компании нужны название и код регистрации — тогда можно заводить продукт.',
  product_incomplete: 'Карточка продукта неполная: не хватает обязательных полей.',
  not_complete: 'Для вариантов нужны название и назначение, полная комплектность не обязательна.',
