...
import { Button, Callout, Card, DemoMark, fill, NextAction, PageHeader, StatusBadge, Table } from '../kit'
...
export function AutomationPage() {
  ...
  return (
    <Shell wide>
      <PageHeader title={t('auto.title')} lead={fill(t('auto.lead'), { code: '#RU-0417' })} />
